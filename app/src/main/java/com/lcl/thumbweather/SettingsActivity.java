...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.e("-LCL-","SettingsActivity:onCreate");
    ...
    public void onResume(){
        super.onResume();
        Log.e("-LCL-", "SettingsActivity:onResume");
    ...
    private void updateDateFormatList() {
        Log.e("119-LCL-","updateDateFormatList");
        ...
        for (int i=0; i<dateFormatsValues.length; i++) {
            Log.e("132-LCL-","updateDateFormatList");
            String value = dateFormatsValues[i];
            Log.e("-LCL-","value:"+value);
            if ("custom".equals(value)) {
                ...
                Log.e("146-LCL-","updateDateFormatList");
